...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    # CREACION Y ENTRENAMIENTO DEL MODELO KNN
    ...
    if variable1 < 10:
        ...
        return func.HttpResponse("Puede que se ingresara un valor mal en el postman pero la funcion se ejecuto correctamente",status_code=200)